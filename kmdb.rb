...
joseph_gordon     = Actor.create(name: "Joseph Gordon-Levitt")
...
Role.create(movie: dark_knight_rises, actor: joseph_gordon,     character_name: "John Blake")
...
movies.each do |movie|
  puts "#{movie.title}  #{movie.release_year}  #{movie.mpaa_rating}  #{movie.studio.name}"
end
